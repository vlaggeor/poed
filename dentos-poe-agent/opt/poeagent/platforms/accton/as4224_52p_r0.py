...
from pd69200.poe_driver_def import (
    POE_PD69200_MSG_DATA_PM1_DYNAMIC,
...
class As4224_52p(PoePlatform):
    # Accton AS4224-52P
    def __init__(self):
        self._max_shutdown_vol = 0x0249  # 56.9 V
        self._min_shutdown_vol = 0x0190  # 50.1 V
    ...
    def default_power_limits(self) -> dict[int, int]:
        """Get the port ranges default power limit
    ...
    def init_poe(self, skip_port_init: bool) -> dict:
        ...
        result["set_power_management"] = {
            AgentConstants.CMD_RESULT_RET: self.set_pm_method(
                POE_PD69200_MSG_DATA_PM1_DYNAMIC, POE_PD69200_MSG_DATA_PM2_PPL, POE_PD69200_MSG_DATA_PM3_NO_COND
            )
        }
